...
public class EurderServiceTest {
    ...
    @Test
    void givenCustomerHasFilledEurderCart_whenFinalizeEurder_thenReturnUpdatedEurderCartDtoFinalized() {
        ...
        EurderDtoOutput result = eurderService.finalizeEurder(cart1.getId(),customer1);
    ...
    @Test
    void givenCustomerHasFilledCartMoreThanItemStock_whenFinalizeEurder_thenReturnUpdatedEurderCartDtoFinalizedAndCorrectShippingDate() {
    ...
    @Test
    void givenCustomerHasEmptyEurderCart_whenFinalizeEurder_thenThrowsException() {
        assertThrows(InvalidInputException.class, () -> eurderService.finalizeEurder(cart1.getId(),customer1));
    }

    @Test
    void givenCustomerHasfinalizedEurder_whenFinalizeEurder_thenThrowsException() {
        cart1.setStatusFinalized();
        assertThrows(InvalidInputException.class, () -> eurderService.finalizeEurder(cart1.getId(),customer1));
    }

    @Test
    void givenInvalidEurderId_whenFinalizeEurder_thenThrowsException() {
        assertThrows(InvalidInputException.class, () -> eurderService.finalizeEurder(cart1.getId(),customer2));
    }

    @Test
    void givenCustomerHasfinalizedEurder_whenReEurder_thenReturnNewEurderDtoFinalized() {
        ...
        cart1.setStatusFinalized();
        eurderRepository.save(cart1);
        EurderDtoOutput result = eurderService.reEurder(cart1.getId(),customer1);
